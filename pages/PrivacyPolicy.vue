      ...
      <div class="privacy-policy__inner">
        <div class="privacy-policy__article">
          ...
          <p>
            ...
            recorded by XDEVS and how we use it.
          </p>
          <p>
        ...
        <div class="privacy-policy__article">
          <h2>Log Files</h2>
          <p>
            XDEVS follows a standard procedure of using log files. These files
        ...
        <div class="privacy-policy__article">
          ...
          <p>
            Like any other website, XDEVS uses 'cookies'. These cookies are used
        ...
        <div class="privacy-policy__article">
          ...
          <p>
            ...
            advertising partners of XDEVS.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on XDEVS, which are
          ...
          <p>
            Note that XDEVS has no access to or control over these cookies that
        ...
        <div class="privacy-policy__article">
          ...
          <p>
            XDEVS's Privacy Policy does not apply to other advertisers or
        ...
        <div class="privacy-policy__article">
          ...
          <p>
            XDEVS does not knowingly collect any Personal Identifiable
