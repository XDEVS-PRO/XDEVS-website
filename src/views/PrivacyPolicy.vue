<template>
  ...
  <div class="privacy-policy__article">
    <title-block :title="'Privacy Policy for XDEVS'"
                 :color-icon="'dark'"
                 class="title-desc"/>
    <h2>Privacy Policy for XDEVS</h2>
    <p>At XDEVS, accessible from https://xdevs.pro/, one of our main priorities is the privacy of our visitors. This
      Privacy Policy document contains types of information that is collected and recorded by XDEVS and how we use
      it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
      regards to the information that they shared and/or collect in XDEVS. This policy is not applicable to any
      information collected offline or via channels other than this website. Our Privacy Policy was created with the
      help of the <a class="custom-link" href="https://www.privacypolicygenerator.org/">Free Privacy Policy Generator</a>.</p>
  </div>
  ...
  <div class="privacy-policy__article">
    <h2>Log Files</h2>
    <p>XDEVS follows a standard procedure of using log files. These files log visitors when they visit websites. All
  ...
  <div class="privacy-policy__article">
    ...
    <p>Like any other website, XDEVS uses 'cookies'. These cookies are used to store information including visitors'
    ...
    <p>For more general information on cookies, please read
      <a class="custom-link" href="https://www.privacypolicyonline.com/what-are-cookies/">"What Are Cookies" from Cookie Consent</a>. </p>
  </div>

  <div class="privacy-policy__article">
    <h2>Advertising Partners Privacy Policies</h2>
    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of XDEVS.</p>
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
      used in their respective advertisements and links that appear on XDEVS, which are sent directly to users'
    ...
    <p>Note that XDEVS has no access to or control over these cookies that are used by third-party advertisers.</p>
  </div>

  <div class="privacy-policy__article">
    <h2>Third Party Privacy Policies</h2>
    <p>XDEVS's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
  ...
  <div class="privacy-policy__article">
    ...
    <ul>
      ...
      <li>The right to rectification – You have the right to request that we correct any information you believe is
        inaccurate. You also have the right to request that we complete the information you believe is incomplete.</li>
  ...
  <div class="privacy-policy__article">
    ...
    <p>XDEVS does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
...
li {
  ...
  &:before {
    ...
    width: 8px;
    height: 8px;
    background: linear-gradient(90deg, #4663FF -0.14%, #17A8D3 99.86%);
    border-radius: 50%;
